                ...
                if message == "Success"{
                    ...
                    if data?.result != nil && data?.result![0].serviceError == ""{
                        ...
                        for questions in questArray{
                            var isVisible:String = questions.visible_question
                    ...
                    if let json = try? JSON(data: jsonObj as! Data) {
                        ...
                        if  errorMsg == ""{
                            ...
                            for item in json["result"].arrayValue {
                                ...
                                if item["ticket_date"].stringValue.count > 5{
                                    ticketDate = item["ticket_date"].stringValue
                                }
                                else {
                                    ticketDate = item["onscene_time"].stringValue
                                }
                                
                                var declarationDate : String = ""
                                if item["declaration_date"].stringValue.count > 5{
                                    declarationDate = item["declaration_date"].stringValue
                                }
                                else {
                                    declarationDate = item["clear_time_of_the_Offrcer"].stringValue
                                }
                                ...
                                let ripas = RipaTempMaster(key:key,
                                                           ...
                                                           ticketDate: convertDateFormater(date: ticketDate) ,
                                                           declarationDate: convertDateFormater(date: declarationDate),
